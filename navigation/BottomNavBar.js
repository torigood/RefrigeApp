                ...
                options={{
                    ...
                    tabBarIcon: ({focused}) => {
                        return (
                            ...
                            borderColor: focused ? "black" : "#F2F2F0", borderRadius: 50, padding: 5,
                            marginLeft: 30,
                            backgroundColor: focused ? "#779E74" : "#F2F2F0"}}>
                                <Image source={recipeIcon} 
                                style={[styles.iconStyle, { tintColor: focused ? 'white' : 'black' }]}/>
                            </View>
                        )
                    },
                    tabBarLabel: ({ focused }) => (
